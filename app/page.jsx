    ...
    <>
      ...
      <section id="about" className="section bg-white w-full text-[#352b4d] text-justify leading-relaxed text-2xl py-8">
        ...
        <div className="bg-white p-8">
          <h2 className="text-4xl text-center">Somos NESS</h2>
            ...
            <p className="max-w-7xl mx-auto text-justify mt-4">
             🎀 Somos una pequeña empresa en el estado Zulia-Venezuela en donde amamos la moda y el estilo unico; nos caracterizamos con valores como
              la responsabilidad, el amor, el respeto, y ademas de ello siempre con actitud positiva y por supuesto con mucho estilo.
              <br/>
          ...
          <p className="max-w-7xl mx-auto text-justify mt-4">
            📍 Nuestro taller artesanal está ubicado en barrio 28 de Diciembre Av. 49 FI, el municipio San Francisco del estado Zulia. Allí es donde ocurre la magia, nos inspiramos en ti y tu estilo de vida. Estamos completamente dedicados a la confección para ofrecer estilos vanguardistas.
          </p>
          <p className="max-w-7xl mx-auto text-justify mt-4">
